...
INSERT INTO instrumento (instrumento, marca, modelo, imagen, precio, costo_envio, cantidad_vendida, descripcion,id_categoria)
...
INSERT INTO instrumento (instrumento, marca, modelo, imagen, precio, costo_envio, cantidad_vendida, descripcion, id_categoria)
VALUES ('Pandereta Pandero Instrumento Musical', 'DyM ventas', '32 sonajas', 'https://http2.mlstatic.com/D_NQ_NP_943866-MLA44548754405_012021-O.webp', 325, '150', '10', '1 Pandereta - 32 sonajas metálicas. Más de 8 años vendiendo con 100 % de calificaciones POSITIVAS y clientes satisfechos !! ',3);
...
INSERT INTO instrumento (instrumento, marca, modelo, imagen, precio, costo_envio, cantidad_vendida, descripcion, id_categoria)
VALUES ('Bar Chimes Lp Cortina Musical 72 Barras', 'FM', 'LATIN', 'https://http2.mlstatic.com/D_NQ_NP_853533-MLA31040848888_062019-O.webp', 2250, 'G', '2', 'BARCHIME CORTINA MUSICAL DE 25 BARRAS LATIN CUSTOM. Emitimos factura A y B',3);
...
INSERT INTO instrumento (instrumento, marca, modelo, imagen, precio, costo_envio, cantidad_vendida, descripcion, id_categoria)
VALUES ('Antiguo Piano Aleman Con Candelabros.', 'Neumeyer', 'Stratus', 'https://http2.mlstatic.com/D_NQ_NP_741625-MLA25468412771_032017-O.webp', 17000, '2000', '0', 'Buen dia! Sale a la venta este Piano Alemán Neumeyer con candelabros incluidos. Tiene una talla muy bonita en la madera. Una pieza de calidad.',4);

INSERT INTO instrumento (instrumento, marca, modelo, imagen, precio, costo_envio, cantidad_vendida, descripcion, id_categoria)
VALUES ('Guitarra Ukelele Infantil Grande 60cm', 'GUITARRA', 'UKELELE', 'https://http2.mlstatic.com/D_NQ_NP_602949-MLA32297056646_092019-O.webp', 500, 'G', '5', 'Material: Plástico smil madera 4 Cuerdas longitud: 60cm, el mejor regalo para usted, su familia y amigos, adecuado para 3-18 años de edad',1);
